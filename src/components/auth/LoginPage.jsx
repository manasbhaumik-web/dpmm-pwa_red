...
const ROLES = [
  {
    ...
    accentBorder: 'border-slate-900/20',
    accentText: 'text-slate-900',
    accentBgLight: 'bg-slate-900/5',
    ringFocus: 'focus:border-slate-900 focus:ring-slate-900/20',
    gradient: 'from-slate-900/10 to-transparent',
